...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    void declare_params(){
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "cumulative") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.cumulative = param.as_bool();
      param = parameters_interface_->get_parameter(prefix_ + "with_world");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "with_world") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.with_world = param.as_bool();
